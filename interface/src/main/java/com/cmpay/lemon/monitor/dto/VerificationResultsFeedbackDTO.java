...
@DataObject
public class VerificationResultsFeedbackDTO {
    /**
     * @Fields id id
     */
    private Long id;
    ...
    public String toString() {
        return "VerificationResultsFeedbackBO{" +
                ...
                ", functionCaseDetail='" + functionCaseDetail + '\'' +
                ", functionCaseFilename='" + functionCaseFilename + '\'' +
                ", functionCaseTime=" + functionCaseTime +
                ", technicalCaseDetail='" + technicalCaseDetail + '\'' +
                ", technicalCaseFilename='" + technicalCaseFilename + '\'' +
                ", technicalCaseTime=" + technicalCaseTime +
