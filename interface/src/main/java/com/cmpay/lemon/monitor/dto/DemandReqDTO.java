 ...
 * @author: zhou_xiong
 */
public class DemandReqDTO extends PageableRspDTO {
    ...
    public DemandReqDTO(String req_inner_seq, String req_nm, String req_no, String devp_lead_dept, String devp_coor_dept,
